...
def plot_radar_charts():
    ...
    radar_23_24.write_html('dashboards/radar/pistons_points_scored_23_24.html')
    radar_24_25.write_html('dashboards/radar/pistons_points_scored_24_25.html')
    radar_combined.write_html('dashboards/radar/pistons_points_scored_combined.html')
